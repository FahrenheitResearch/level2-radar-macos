...
uint32_t defaultColorForGroup(WarningGroup group) {
    switch (group) {
        case WarningGroup::Tornado: return 0xFF4848EBu;
        case WarningGroup::Severe:  return 0xFF2EA4FFu;
        case WarningGroup::Fire:    return 0xFF4A79FFu;
        case WarningGroup::Flood:   return 0xFF6CD65Cu;
        case WarningGroup::Marine:  return 0xFFFFBE58u;
