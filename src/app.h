...
public:
    ...
    void render();
    bool needsRender() const { return m_needsRerender || m_needsComposite; }
...
private:
    ...
    void refreshWarningOverlayState();
    ...
    std::unique_ptr<Downloader> m_liveLoopDownloader;
...
public:
    ...
    uint64_t m_warningOverlaySignature = 0;
...
public:
    ...
    id<MTLBuffer> m_liveLoopFrames[MAX_LIVE_LOOP_FRAMES] = {};
    ...
    int m_liveLoopBackfillStationIdx = -1;
    std::string m_liveLoopBackfillCurrentKey;
};
